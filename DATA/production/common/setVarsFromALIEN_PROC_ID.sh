...
# let's get the last 10 (for int) and 9 (for int16) digits of ALIEN_PROC_ID, to be passed to define NUMAID and shm-segment-id via O2JOBID, which are int and int16 respectively. Then we make them an int or int16
ALIEN_PROC_ID_MAX_NDIGITS_INT32=10
ALIEN_PROC_ID_MAX_NDIGITS_INT16=9
ALIEN_PROC_ID_LENTGH=`echo $ALIEN_PROC_ID | wc -c`
...
ALIEN_PROC_ID_OFFSET_INT32=$((10#${ALIEN_PROC_ID:$((ALIEN_PROC_ID_OFFSET_INT32))}))
ALIEN_PROC_ID_OFFSET_INT16=$((10#${ALIEN_PROC_ID:$((ALIEN_PROC_ID_OFFSET_INT16))}))
